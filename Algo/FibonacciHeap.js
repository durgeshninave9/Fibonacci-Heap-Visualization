FibonacciHeap.LINK_COLOR = "#ffffff";
FibonacciHeap.FOREGROUND_COLOR = "#7B647F"; // for circle outline color
FibonacciHeap.BACKGROUND_COLOR = "#EBEEA3"; // for circle background color
FibonacciHeap.INDEX_COLOR = "#322a20";
...
FibonacciHeap.prototype.addControls = function () {
	...
	this.insertField.className = "input-field"; // add class name "input-field"
	this.insertField.onkeydown = this.returnSubmit(this.insertField, this.insertCallback.bind(this), 6);
	this.controls.push(this.insertField);

	this.insertButton = addControlToAlgorithmBar("Button", "Insert Node");
	this.insertButton.className = "btn"; // add class name "btn"
	this.insertButton.onclick = this.insertCallback.bind(this);
	this.controls.push(this.insertButton);

	this.removeSmallestButton = addControlToAlgorithmBar("Button", "Remove Smallest Node");
	this.removeSmallestButton.className = "btn"; // add class name "btn"
	...
	this.clearHeapButton.className = "btn"; // add class name "btn"
...
FibonacciHeap.prototype.SetAllTreePositions = function (tree, treeList, tree2) {
	...
	if (tree2 != null && tree2 != undefined) {
		leftSize = this.setPositions(tree2, leftSize, FibonacciHeap.STARTING_Y); 
	}
	if (tree != null) {
		leftSize = this.setPositions(tree, leftSize, FibonacciHeap.STARTING_Y); 

	}
	for (var i = 0; i < treeList.length; i++) {
		if (treeList[i] != null) {
			leftSize = this.setPositions(treeList[i], leftSize, FibonacciHeap.STARTING_Y); 
		}
	}
}
